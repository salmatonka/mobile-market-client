...
const OfferPhones = () => {
	...
	<div className="container mx-auto space-y-12">
		<div className="flex flex-col overflow-hidden rounded-md shadow-sm lg:flex-row">
			<img src="https://azse77seaprodsa.blob.core.windows.net/b2b-dr-pickaboocdn/media/dcastalia_hybridslider/image/Super_Offer_app_b_anner_2_.jpg" alt="" className="h-80 dark:bg-gray-500 aspect-video" />
