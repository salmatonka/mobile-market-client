...
const Blog = () => {
    return (
        <div className='pb-20 pt-36 bg-gradient-to-tr to-purple-100 from-cyan-100'>
        <h1 className='text-5xl font-bold pt-8 pb-14 flex justify-center'> My Blog</h1>
        <div className="hero min-h-screen mb-10">
            <div className="hero-content bg-gradient-to-tr to-purple-200 from-cyan-200 flex-col lg:w-4/5 card shadow-xl">
